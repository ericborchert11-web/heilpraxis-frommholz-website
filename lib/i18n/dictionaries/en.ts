...
export const en: Dictionary = {
  ...
  hero: {
    ...
    ctaCall: 'Call us',
    imageAlt: 'The Heilpraxis Frommholz team with a client during care at home',
  ...
  kontakt: {
    ...
    subjects: [
      ...
      'One-to-one care / night care',
      '24-hour care',
      'Care consulting',
      'Travel companion care',
      'Support in the final phase of life',
      'Something else',
    ],
  ...
  leistungenPage: {
    title: 'Our services',
    lead: 'Seven ways in which we support people in Berlin — from one-to-one care by the hour to round-the-clock care at home. All privately paid, delivered by a small, settled team.',
    more: 'Learn more',
  ...
  familienbereichPage: {
    ...
    lead: 'When someone is being looked after, their family wants to know what is happening — even when they cannot be there in person. The family portal gives you exactly that: protected online access to schedules, invoices and documentation. Included for every one of our clients.',
  ...
  sozialesEngagementPage: {
    ...
    vereinAfter: 'The association contributes a volunteer network and many years of experience in accompanying people who need support on journeys — a complement to our paid nursing shifts.',
    ...
    karriereLinkEhrenamt: 'Paid voluntary work: one-to-one care',
  ...
  indexMeta: {
    ...
    leistungen: {
      ...
      description:
        'One-to-one care, night care, round-the-clock care at home and care counselling in Berlin. Privately paid, from a small and settled team.',
    },
    themen: {
